...
$pageTitle = 'Search for Classes "'. $q.'"';
...
include 'includes/student_sidebar.php';
        ...
        <main class="add-course">
            ...
            <div class="container">
                ...
                <!-- list of lectures -->
            <?php
$query = mysqli_query($con, "SELECT * FROM class WHERE title LIKE '%$q%' OR description LIKE '%$q%' ") or die(mysqli_error($con));
$lectures = mysqli_num_rows($query);

if ($lectures == 0) {
    echo "<h1 class='text-center mt-5'>No classes Found</h1>";
} else {
